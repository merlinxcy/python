...
logframe=Frame(main)
titleframe.grid(sticky=W,row=0,column=0)
buttonframe.grid(sticky=W,row=1,column=0)
confframe.grid(sticky=W,row=1,column=0,padx=500,ipadx=30,ipady=30)
logframe.grid(sticky=W,row=2,column=0)
##titleframe
...
button3=Button(buttonframe,text='               ')
button4=Button(buttonframe,text='               ')
button5=Button(buttonframe,text='               ')
button6=Button(buttonframe,text='               ')
...
log1=Listbox(logframe,yscrollcommand=bar.set)
log2=Listbox(logframe,yscrollcommand=bar.set)
log3=Listbox(logframe,yscrollcommand=bar.set)
log4=Listbox(logframe,yscrollcommand=bar.set)
log5=Listbox(logframe,yscrollcommand=bar.set)
